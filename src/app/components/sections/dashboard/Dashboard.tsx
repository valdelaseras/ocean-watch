...
const Dashboard: FC = () => (
  <Section id="dashboard" title="Dashboard" titleClass="font-xl">
    <Content colSize="column">
      <DropdownCheckbox id="test" className="idk" title="A title">
        <p>A child</p>
      </DropdownCheckbox>
      {/*<div>*/}
      ...
      {/*    <li>*/}
      {/*      <p>*/}
      {/*        - Feed ( consisting of sightings according to current user settings ). The feed also has its own util bar at*/}
      {/*        the top ( not fixed ) to sort & filter feed*/}
      {/*      </p>*/}
      {/*    </li>*/}
      {/*    <li>*/}
      {/*      <p>*/}
      ...
      {/*      <p>*/}
      {/*        Other icons ( with a max of maybe 4 - 5 icons in TOTAL in this bar ) may be 'hotlinks (??)' to features user*/}
      {/*        has set themselves ( for example low tide notifier/info, icon to settings if they prefer, icon to their*/}
      {/*        profile, their own sightings feed or whatever ). If no custom icons, an icon with a plus is displayed*/}
      {/*        instead, next to the mandatory icons*/}
      {/*      </p>*/}
      {/*    </li>*/}
      {/*  </ul>*/}
      {/*</div>*/}
